...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.GetFaceContainingPoint (
  atopology text,
  apoint geometry
);
 RAISE NOTICE 'newly registered FUNCTION topology.GetFaceContainingPoint (
  atopology text,
  apoint geometry
)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.GetFaceContainingPoint (
  atopology text,
  apoint geometry
)';
  ELSE
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.ST_Srid (tg topology.TopoGeometry);
 RAISE NOTICE 'newly registered FUNCTION topology.ST_Srid (tg topology.TopoGeometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_Srid (tg topology.TopoGeometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.TopoGeom_addTopoGeom (tgt topology.TopoGeometry, src topology.TopoGeometry);
 RAISE NOTICE 'newly registered FUNCTION topology.TopoGeom_addTopoGeom (tgt topology.TopoGeometry, src topology.TopoGeometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.TopoGeom_addTopoGeom (tgt topology.TopoGeometry, src topology.TopoGeometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.FindTopology (TopoGeometry);
 RAISE NOTICE 'newly registered FUNCTION topology.FindTopology (TopoGeometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.FindTopology (TopoGeometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.FindTopology (regclass, name);
 RAISE NOTICE 'newly registered FUNCTION topology.FindTopology (regclass, name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.FindTopology (regclass, name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.FindTopology (name, name, name);
 RAISE NOTICE 'newly registered FUNCTION topology.FindTopology (name, name, name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.FindTopology (name, name, name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.FindTopology (text);
 RAISE NOTICE 'newly registered FUNCTION topology.FindTopology (text)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.FindTopology (text)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.FindTopology (integer);
 RAISE NOTICE 'newly registered FUNCTION topology.FindTopology (integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.FindTopology (integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.FindLayer (tg TopoGeometry);
 RAISE NOTICE 'newly registered FUNCTION topology.FindLayer (tg TopoGeometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.FindLayer (tg TopoGeometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.FindLayer (layer_table regclass, feature_column name);
 RAISE NOTICE 'newly registered FUNCTION topology.FindLayer (layer_table regclass, feature_column name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.FindLayer (layer_table regclass, feature_column name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.FindLayer (schema_name name, table_name name, feature_column name);
 RAISE NOTICE 'newly registered FUNCTION topology.FindLayer (schema_name name, table_name name, feature_column name)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.FindLayer (schema_name name, table_name name, feature_column name)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.FindLayer (topology_id integer, layer_id integer);
 RAISE NOTICE 'newly registered FUNCTION topology.FindLayer (topology_id integer, layer_id integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.FindLayer (topology_id integer, layer_id integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology._ValidateTopologyGetFaceShellMaximalEdgeRing (atopology varchar, aface int);
 RAISE NOTICE 'newly registered FUNCTION topology._ValidateTopologyGetFaceShellMaximalEdgeRing (atopology varchar, aface int)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology._ValidateTopologyGetFaceShellMaximalEdgeRing (atopology varchar, aface int)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology._ValidateTopologyGetRingEdges (starting_edge int);
 RAISE NOTICE 'newly registered FUNCTION topology._ValidateTopologyGetRingEdges (starting_edge int)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology._ValidateTopologyGetRingEdges (starting_edge int)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology._CheckEdgeLinking (curedge_edge_id INT, prevedge_edge_id INT, prevedge_next_left_edge INT, prevedge_next_right_edge INT);
 RAISE NOTICE 'newly registered FUNCTION topology._CheckEdgeLinking (curedge_edge_id INT, prevedge_edge_id INT, prevedge_next_left_edge INT, prevedge_next_right_edge INT)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology._CheckEdgeLinking (curedge_edge_id INT, prevedge_edge_id INT, prevedge_next_left_edge INT, prevedge_next_right_edge INT)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology._ValidateTopologyEdgeLinking (bbox geometry );
 RAISE NOTICE 'newly registered FUNCTION topology._ValidateTopologyEdgeLinking (bbox geometry )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology._ValidateTopologyEdgeLinking (bbox geometry )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology._ValidateTopologyRings (bbox geometry );
 RAISE NOTICE 'newly registered FUNCTION topology._ValidateTopologyRings (bbox geometry )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology._ValidateTopologyRings (bbox geometry )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.ValidateTopology (toponame varchar, bbox geometry );
 RAISE NOTICE 'newly registered FUNCTION topology.ValidateTopology (toponame varchar, bbox geometry )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ValidateTopology (toponame varchar, bbox geometry )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.ValidateTopologyRelation (toponame varchar);
 RAISE NOTICE 'newly registered FUNCTION topology.ValidateTopologyRelation (toponame varchar)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ValidateTopologyRelation (toponame varchar)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
