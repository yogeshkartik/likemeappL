...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_Contour (
		rast raster,
		bandnumber integer ,
		...
		fixed_levels float8[] ,
		polygonize boolean );
 RAISE NOTICE 'newly registered FUNCTION ST_Contour (
		rast raster,
		bandnumber integer ,
		level_interval float8 ,
		level_base float8 ,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_Contour (
		rast raster,
		bandnumber integer ,
		level_interval float8 ,
		level_base float8 ,
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION ST_InterpolateRaster (
		geom geometry,
		options text,
		rast raster,
		bandnumber integer );
 RAISE NOTICE 'newly registered FUNCTION ST_InterpolateRaster (
		geom geometry,
		options text,
		rast raster,
		bandnumber integer )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION ST_InterpolateRaster (
		geom geometry,
		options text,
		rast raster,
		bandnumber integer )';
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_value (rast raster, band integer, pt geometry, exclude_nodata_value boolean , resample text );
 RAISE NOTICE 'newly registered FUNCTION st_value (rast raster, band integer, pt geometry, exclude_nodata_value boolean , resample text )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_value (rast raster, band integer, pt geometry, exclude_nodata_value boolean , resample text )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setz (rast raster, geom geometry, resample text , band integer );
 RAISE NOTICE 'newly registered FUNCTION st_setz (rast raster, geom geometry, resample text , band integer )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setz (rast raster, geom geometry, resample text , band integer )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION st_setm (rast raster, geom geometry, resample text , band integer );
 RAISE NOTICE 'newly registered FUNCTION st_setm (rast raster, geom geometry, resample text , band integer )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION st_setm (rast raster, geom geometry, resample text , band integer )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_raster ADD FUNCTION _st_pixelascentroids (
	rast raster,
	band integer ,
	columnx integer ,
	rowy integer ,
	exclude_nodata_value boolean );
 RAISE NOTICE 'newly registered FUNCTION _st_pixelascentroids (
	rast raster,
	band integer ,
	columnx integer ,
	rowy integer ,
...
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_raster\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION _st_pixelascentroids (
	rast raster,
	band integer ,
	columnx integer ,
	rowy integer ,
